...
if ($page === 'billing') {
    ...
    if (!$stmt->execute()) {
        die("Billing execute error: " . $stmt->error);
    }
    ...
    <div class="list">
        ...
        <?php while ($invoice = $rows->fetch_assoc()): ?>
            ...
            <div class="card">
                ...
                <div class="muted">
                    Payment Status:
                    <?= e(ucfirst($invoice['payment_status'])) ?>
                </div>
...
if ($page === 'profile') {
    ...
    if (!$stmt->execute()) {
        die("Profile execute error: " . $stmt->error);
    }
...
<div class="detail-card">
    ...
    <form
        method="post"
        action="../controllers/profile_save.php"
    ...
    <form
        method="post"
        action="../controllers/password_save.php"
        class="form"
    >
